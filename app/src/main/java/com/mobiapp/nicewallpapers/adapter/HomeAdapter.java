...
public class HomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<PhotoGoup> mPhotos;
    private Context mContext;
    private int mHeightItem;
    private View.OnClickListener mOnClickListener;

    public HomeAdapter(Context context, ArrayList<PhotoGoup> photos, View.OnClickListener onClickListener) {
        mContext = context;
        mPhotos = photos;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ViewHolderHeader) {
            ...
            Glide.with(mContext).load(urlImage)
                    ...
                    .centerCrop()
                    .dontAnimate()
                    .into(viewHolderHeader.imgHeader);
            viewHolderHeader.itemView.setOnClickListener(mOnClickListener);
